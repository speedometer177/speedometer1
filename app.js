...
heroBannerArticles=pool;heroBannerIdx=0;const n=pool.length;const extended=[pool[n-1],...pool,pool[0]];const startIdx=1;const slideHTML=(a,i)=>{const timeStr=a.time?(' · '+escapeHtml(a.time)):'';return '<div class="hero-banner-slide" onclick="openArticle('+a.id+')" role="button" tabindex="0" data-id="'+a.id+'">'
